...
func InitApiRouter(engine *gin.Engine) {
	...
	engine.GET("/workbench/bootstrap", middleware.JwtApiMiddleware, controller.GetWorkbenchBootstrap)
	engine.GET("/agents/status", middleware.JwtApiMiddleware, controller.GetAgentStatus)
